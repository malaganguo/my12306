...
var HighchartsAdapter = function () {
  ...
  return{init: function (c) {
    if (!l.defaultView)this._getStyle = function (a, d) {
      var b;
    ...
    this.animate = function (a, d, b) {
      ...
      for (g in d)i = new n(a, b, g), f = null, g === "d" ? (i.paths = c.init(a, a.d, d.d), i.toD = d.d, e = 0, f = 1) : a.attr ? e = a.attr(g) : (e = parseFloat(HighchartsAdapter._getStyle(a, g)) || 0, g !== "opacity" && (h = "px")), f || (f = parseFloat(d[g])), i.custom(e, f, h)
    }
